...
btc_log_vehicle_selected attachTo [_tower, [0, _relative_pos select 1,  0.5 + ((btc_log_vehicle_selected modelToWorld [0,0,0]) select 2) - ((_tower  modelToWorld [0,0,0]) select 2)]];
